...
<body>
    <div class="row">
        <div class="col-md-6 mx-auto p-0">
            <div class="card">
                <div class="login-box">
                    <div class="login-snip"> <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab"> Login</label> <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab">Signup</label>
                        <div class="login-space">
                            <form method="POST" action="demo" class="login" id="formlogin">
                                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <form class="sign-up-form"  method="POST" action="demo">
                                <?php echo csrf_field(); ?>
                                <div class="grid">
                                <div class="group"> <label for="Name" class="label">First Name</label>
                                    <input id="Name" type="text" class="input1"  name="firstname" placeholder="Create your First Name"></div>
...
unset($__errorArgs, $__bag); ?>
                                    <div class="group"> <label for="Name" class="label">Last Name</label>
                                    <input id="Name" type="text" class="input1"  name="lastname" placeholder="Create your Last Name"></div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="group"> <label for="user" class="label">Username</label> 
                                    <input id="user" type="text" class="input1"  name="username" placeholder="Create your Username"> </div>
                                    <?php $__errorArgs = ['username'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="group"> <label for="pass" class="label">Password</label> 
                                    <input id="pass" type="password" class="input" name="password"  data-type="password" placeholder="Create your password"> </div>
                                    <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="grid">
                                    <div class="group"> <label for="pass" class="label">Age</label> 
                                    <input id="age" type="text" class="input1" data-type="Number" name="age"  placeholder="Enter age"> </div>
                                    <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                    <div class="group"> <label for="Gender" class="label">Gender</label>
                                    <input type="text" name="gender" id="gender" class="input1"  name="gender"   placeholder="Enter gender"></div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="grid">
                                    ...
                                    <input id="pass" type="text" class="input1"  name="email" placeholder="Enter your email address"> </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <input id="phone" type="text" class="input1" name="contact"   placeholder="Enter your Phone Number"> </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="group"><label for="country" class="label">Country</label>
...
</html><?php /**PATH G:\laravelproject\resources\views/demo.blade.php ENDPATH**/ ?>