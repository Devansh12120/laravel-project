...
<!--<div><input type='button' value="play again" onclick="playAgain()"/></div>-->
<h3 style="text-align: center;">Save Me</h3>
<div id="container" style="text-align: center;padding-top:25px;">
    <canvas id="gameCanvas" width="800" height="500" style="border:1px solid #d3d3d3;background: url(bac.jpg);" onclick="playAgain()">
...
<script>
    ...
    function gamemousemove() {
        if (currentLoopCountOffset == mouseOffset) {
            ...
            /*
             ctx.fillText("x : " + event.pageX, container.width*0.8, 10);
             ctx.fillText("Y : " + event.pageY, container.width*0.8, 50);
             ctx.fillText("Player X : " + player.x, container.width*0.8, 90);
             ctx.fillText("Player Y : " + player.y, container.width*0.8, 130);
             */
...
</script><?php /**PATH G:\laravelproject\resources\views/save.blade.php ENDPATH**/ ?>