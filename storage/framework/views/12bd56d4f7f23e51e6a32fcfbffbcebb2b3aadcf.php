...
-->
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/bootstrap.min.css')); ?>">                                      <!-- Bootstrap style -->
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/templatemo-style.css')); ?>">                                   <!-- Templatemo style -->
    <!-- <link rel="stylesheet" href="<?php echo e(URL::asset('')); ?>">                                    -->
      </head>
    ...
    <!-- load JS files -->
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery-1.11.3.min.js')); ?>"  ></script>             <!-- jQuery (https://jquery.com/download/) -->
    <script type="text/javascript" src="<?php echo e(URL::asset('js/popper.min.js')); ?>"   ></script>                    <!-- https://popper.js.org/ -->       
    <script type="text/javascript" src="<?php echo e(URL::asset('js/bootstrap.min.js')); ?>"   ></script>                 <!-- https://getbootstrap.com/ -->
    <script type="text/javascript" src="<?php echo e(URL::asset('js/datepicker.min.js')); ?>"   ></script>                <!-- https://github.com/qodesmith/datepicker -->
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.singlePageNav.min.js')); ?>"   ></script>      <!-- Single Page Nav (https://github.com/ChrisWojcik/single-page-nav) -->
    <script type="text/javascript" src="<?php echo e(URL::asset('slick/slick.min.js')); ?>"   ></script>                  <!-- http://kenwheeler.github.io/slick/ -->
    <script type="text/javascript" src="<?php echo e(URL::asset('js/jquery.scrollTo.min.js')); ?>"   ></script>           <!-- https://github.com/flesler/jquery.scrollTo -->
    <script> 
        /* Google Maps
        ------------------------------------------------*/
        var map = '';
...
</html><?php /**PATH G:\laravelproject\resources\views/destinations.blade.php ENDPATH**/ ?>